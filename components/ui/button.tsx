...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        default:
          "bg-white text-black border border-slate-200 border-2 border-b-[4px] active:border-b-[2px] hover:bg-slate-100 text-slate-500",
        primary:
        ...
        ghost:
          "bg-transparent text-slate-500 border-0 border-transparent hover:bg-slate-200",
        sidebar:
          "bg-transparent text-slate-500 border-2 border-transparent hover:border-slate-100 transition-none",
        sidebarOutline:
